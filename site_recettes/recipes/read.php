...
$retrieveRecipeWithCommentsStatement = $mysqlClient->prepare('SELECT r.recipe_id AS id, title, recipe, author, is_enabled, comment_id, user_id, c.recipe_id, comment FROM recipes r LEFT JOIN comments c on r.recipe_id = c.recipe_id WHERE r.recipe_id = :id ');
...
$recipe = [
    'recipe_id' => $recipeWithComments[0]['id'],
